...
namespace TourGo.Services.Hotels
{
    public class RoomService : IRoomService
    {
        ...
        public void Update(RoomUpdateRequest model, string userId, string hotelId)
        {
            string proc = "rooms_update_v3";
