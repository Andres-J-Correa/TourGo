...
{
    [Route("api/hotel/{hotelId}/finance-partners")]
    [ApiController]
    public class FinancePartnersController : BaseApiController
    {
        ...
        public ActionResult<SuccessResponse> Update(FinancePartnerUpdateRequest model, string hotelId)
        {
            ObjectResult result = null;
            ...
            {
                string userId = _webAuthService.GetCurrentUserId();
                _financePartnerService.Update(model, userId, hotelId);
        ...
        public ActionResult<SuccessResponse> Delete(int id, string hotelId)
        {
            ...
            {
                string userId = _webAuthService.GetCurrentUserId();
                _financePartnerService.Delete(id, userId, hotelId);
